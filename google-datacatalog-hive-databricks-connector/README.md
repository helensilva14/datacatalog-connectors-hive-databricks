...
<your-env>/bin/pip install google-datacatalog-hive-databricks-connector
```
...
<your-env>\Scripts\pip.exe install google-datacatalog-hive-databricks-connector
```
...
cd datacatalog-connectors-hive-databricks/google-datacatalog-hive-databricks-connector
````
...
```bash
google-datacatalog-hive-databricks-connector \
