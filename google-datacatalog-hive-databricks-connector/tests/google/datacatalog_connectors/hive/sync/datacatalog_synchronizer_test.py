...
@patch('google.datacatalog_connectors.hive_databricks.scrape.'
       'MetadataDatabaseScraper.__init__', lambda self, *args: None)
@patch('google.datacatalog_connectors.hive_databricks.prepare.'
...
class DatacatalogSynchronizerTestCase(unittest.TestCase):
    ...
    @patch('google.datacatalog_connectors.hive_databricks.'
